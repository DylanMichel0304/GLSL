...
int main(){
    ...
    try {
        ...
        Texture brick((path + "/brick.png").c_str(), GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
        ...
        // Set initial mouse mode for FPS camera
